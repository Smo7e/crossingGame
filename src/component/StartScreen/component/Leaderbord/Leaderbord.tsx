...
export const saveToLeaderboard = async (time: number, moves: number, name: string) => {
...
const Leaderboard: React.FC<LeaderboardProps> = ({ onClose }) => {
    ...
    return (
        <>
            ...
            <button style={{ fontSize: "min(2vw, 3vh)", height: "min(6.5vh, 6.5vw)" }} onClick={() => onClose(false)}>
                Назад
            </button>
